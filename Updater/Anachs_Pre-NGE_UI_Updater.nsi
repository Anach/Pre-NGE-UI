...
;--------------------------------
;Defines Install Virus on Caveman's Comp
  !define NAME "Anach's Pre-NGE UI"
  !define FILENAME "Anachs_Pre-NGE_UI"
  !define OUTFILE "${FILENAME}_Updater.exe"
...
"No updates for ${NAME} available at this time."\
IDOK done
